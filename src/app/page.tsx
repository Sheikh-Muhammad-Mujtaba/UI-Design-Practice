...
{/* Contact section */}
      {/* <div  className="max-w-[1440px]">
        <h1 className="absolute w-[312px] h-[64px] left-[135px] top-[2912px] font-['Roboto'] not-italic font-light text-[40px] md:text-[64px] leading-[64px] text-[#BDBDBD]">Contact Us</h1>
        ...
        <Image src={"/images/image-12.png"} alt="Contact Image" width={749} height={369} className="absolute max-w-[749px] max-h-[369px] left-[556px] top-[2998px]" />
