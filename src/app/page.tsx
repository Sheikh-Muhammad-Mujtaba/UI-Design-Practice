...
export default function Home() {
  return (
    <div className="relative flex flex-col">
      ...
      {/* Projects Seection  */}
      <div id="projects" className="relative max-w-[1440px] top-[300px] sm:top-[1300px] xl:top-[2027px] flex justify-center ">
      ...
      {/* Contact section */}
      <div id="contact" className="relative w-[80%] sm:w-[100%] top-[1600px] xs:top-[1700px] sm:top-[2950px] lg:top-[2312px] xl:top-[2912px] justify-center">
